...
$db = dbconn();
    ...
    while($row = $query->fetch_assoc()) {
        ...
        <h1><p class="card-title text"><?=$row['Название товара']?></p></h1>
        <h1><p class="card-text text"><?=$row['Бренд']?></p></h1>
        <br>
          ...
          <div class="row g-0 card1">
            ...
            <div class="col-md-8">
              <div class="card-body bor">
                ...
                <p class="card-text"><?=$row['Цена']?></p>
                <p class="card-text"><?=$row['Артикул']?></p>
